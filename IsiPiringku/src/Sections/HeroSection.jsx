...
export default function HeroSection() {
	return (
		<div id="hero" className=" scroll-mt-24 w-full pl-4 sm:pl-8 md:pl-16 lg:pl-32 pr-0 flex flex-col-reverse md:flex-row items-center justify-between py-8 md:min-h-[calc(100vh-64px)] relative z-10">
			{/* Text Section */}
			<div className="text-center md:text-left max-w-xl space-y-5">
				...
				<p className="text-black ml-[-1rem] md:text-[18px] text-xl font-semibold">
					Dukung pertumbuhan optimal si kecil dan <br /> kesehatan ibu
					dengan panduan gizi yang praktis, terpercaya, dan
					menyenangkan
				</p>
				<button className="bg-[#4CAF50]/40 text-black font-bold py-2 px-7 rounded-md transition hover:bg-[#66BB6A] ml-[-1rem]">
					Download
				</button>
			</div>
